...
import AgentRcaCard from './AgentRcaCard';
import ConfidenceScoreCard from './ConfidenceScoreCard';
import PatternMatchCard from './PatternMatchCard';
import EvidenceValidationTable from './EvidenceValidationTable';
...
import ConfidenceEnginePipeline from './ConfidenceEnginePipeline';
import PlatformVisionSection from './PlatformVisionSection';
import MetricsDashboard from './MetricsDashboard';
import PromptContractCard from './PromptContractCard';
...
export default function KubernetesRcaDemo() {
  ...
  return (
    <div className="demo-main">
      <div className="demo-stage-header">
        <div>
          <div className="eyebrow">Use Case 01 · Kubernetes RCA Validation</div>
